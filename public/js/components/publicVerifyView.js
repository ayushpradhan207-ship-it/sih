      ...
      <div class="max-w-4xl mx-auto px-margin-mobile md:px-margin-desktop pt-24 md:pt-28 pb-section-gap flex flex-col gap-stack-lg min-h-screen">
        ...
        <section class="bg-surface-container-lowest rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-surface-variant/40 overflow-hidden" id="verification-card">
          ...
          <div class="bg-primary-container p-6 md:p-8 text-on-primary text-center relative overflow-hidden">
            ...
            <h1 class="font-headline-lg-mobile md:font-headline-lg font-bold text-white tracking-tight">Verifiable Skill Passport Authenticated</h1>
            <p class="font-body-md text-xs text-secondary-fixed mt-1">Cryptographically Validated via W3C Verifiable Credentials v1.1 Standard</p>
          </div>
          ...
          <div class="p-6 md:p-8">
            ...
            <div class="mb-6">
              <h2 class="font-headline-md text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-3">Authentic Demonstrated Skills</h2>
            ...
            <div class="p-5 rounded-2xl bg-primary-container text-white text-xs font-mono mb-6 border border-primary/20">
              <div class="flex justify-between items-center text-on-primary-container text-[10px] font-label-md uppercase font-bold mb-2">
                <span>Cryptographic Proof Status</span>
                <span class="text-tertiary-fixed-dim flex items-center gap-1">
                  <span class="material-symbols-outlined text-[14px]">check_circle</span> Ed25519 Signature Match
                </span>
              </div>
              <div class="text-slate-300 break-all leading-relaxed">
              ...
              <div class="mt-2 text-on-primary-container text-[10px]">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-surface-variant/40">
              <a href="#/" class="text-xs font-label-md font-semibold text-on-surface-variant hover:text-primary transition-colors flex items-center gap-1">
                ...
                <span>Back to VeriSkill Platform</span>
              </a>
